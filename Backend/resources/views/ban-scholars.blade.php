    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0);">All scholars</a></li>
            </ol>
        </div>
    </div>
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">All scholars List  </h4>
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$ban->name}}</td>
                                            <td>{{$ban->email}}</td>
                                            <td>{{ Carbon\Carbon::parse($ban->created_at)->format('Y-m-d') }}</td>
                                             <td>
                                                <form action="/unbanScholar?scholars_id={{$ban->scholars_id}}" method="POST">
                                                @csrf
